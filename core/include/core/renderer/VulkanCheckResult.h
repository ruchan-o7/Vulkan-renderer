...
static std::unordered_map<VkResult, std::string> ErrorDescriptions = {
    ...
    {VK_ERROR_FRAGMENTED_POOL,
     ...
     "returned in preference to VK_ERROR_OUT_OF_POOL_MEMORY, but only if the "
    ...
    {VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT,
     ...
     "have exlusive full-screen access. This may occur due to "
...
// #define DEVICE Renderer::Get().context->GetDevice().GetLogicalDevice()
#define DEVICE Renderer::Get().context->device

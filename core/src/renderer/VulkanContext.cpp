...
VkShaderModule VulkanContext::createShaderModule(const List<char>& code) {
...
List<const char*> VulkanContext::getRequiredExtensions() {
  u32 glfwExtensionCount = 0;
  const char** glfwExtensions;
  glfwExtensions = glfwGetRequiredInstanceExtensions(&glfwExtensionCount);

  List<const char*> extensions(glfwExtensions,
